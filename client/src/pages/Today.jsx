...
import { Sun, Star, Plus, Sunrise, Sunset, Moon } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle={`Focus on what matters most for ${new Date().toLocaleDateString('en-US', {
          month: 'long',
          day: 'numeric',
          year: 'numeric'
        })}`}
      ...
      {isLoading ? (
        <LoadingSpinner message="Loading your daily schedule..." fullPage />
      ) : isError ? (
        <p className="text-center text-rose-500 font-semibold py-8">Failed to load today's tasks.</p>
      ) : (
        <>
          {/* Today's Top 3 Priority Section */}
          <Card className="bg-gradient-to-r from-amber-500/10 via-planner-card to-amber-500/5 border-amber-200 dark:border-amber-900/60">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h2 className="text-lg font-bold text-planner-text">Today's Top 3 Priorities</h2>
            ...
            {top3Tasks.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                {top3Tasks.map((task, idx) => (
                  <div
                    key={task._id}
                    className="p-4 rounded-2xl bg-planner-card border border-amber-200 dark:border-amber-800 shadow-cozy flex items-start justify-between gap-2"
                  >
                    <div className="flex items-start gap-3 min-w-0">
                      <span className="w-6 h-6 rounded-full bg-amber-100 dark:bg-amber-950 text-amber-700 dark:text-amber-300 font-bold text-xs flex items-center justify-center shrink-0 mt-0.5">
                        {idx + 1}
                      </span>
              ...
              <Card>
                <div className="flex items-center justify-between pb-3 mb-3 border-b border-planner-border">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-bold text-planner-text">Morning</h3>
                  </div>
              ...
              <Card>
                <div className="flex items-center justify-between pb-3 mb-3 border-b border-planner-border">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-bold text-planner-text">Afternoon</h3>
                  </div>
              ...
              <Card>
                <div className="flex items-center justify-between pb-3 mb-3 border-b border-planner-border">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-bold text-planner-text">Evening</h3>
                  </div>
